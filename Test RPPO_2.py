...
class CollectHealthSlow(CollectHealth):
    ...
    def __init__(self, *args, depletion_factor: float = 0.05, **kwargs):
        super().__init__(*args, **kwargs)
        # CollectHealth passes max_episode_steps internally to MiniWorldEnv.
        # Overwrite after init to avoid duplicate-kwarg errors while still
        # extending the internal truncation horizon.
...
class StatsCallback(BaseCallback):
    def __init__(self, reward_threshold=3000.0):
        super().__init__()
        self.ep_rewards       = []
        self.ep_lengths       = []
...
if __name__ == "__main__":
    ...
    stats_callback = StatsCallback(reward_threshold=3000.0)
